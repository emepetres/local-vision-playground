...
This is a flat, stylized illustration of a tidy office desk. At the center is a grey
laptop with a blue screen showing horizontal lines...
```
...
`docs/fixtures/reference-frame.jpg` is the reference Frame: 640×480, drawn rather than
photographed so it is ours to redistribute, and regenerated by
`uv run python tools/make_reference_frame.py`.
